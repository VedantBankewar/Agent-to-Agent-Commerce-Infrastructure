...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center pt-24 overflow-hidden bg-black" id="hero">
      ...
      <div className="relative z-10 max-w-5xl px-10 text-center">
        ...
        <div className="flex flex-col md:flex-row gap-4 justify-center items-center">
          ...
          <button className="bg-white/5 border border-white/10 text-on-surface px-12 py-4 rounded-lg text-lg font-bold backdrop-blur-md hover:bg-white/10 transition-all">View Documentation</button>
        </div>
      </div>
    </section>
  );
